...
public class UnsafeTest {
    ...
    {  
        ...
        Field stringFiled  =  clazz.getDeclaredField("strParam")  ;  
        ...
        String c =(String) stringFiled.get(target);
        ...
        String cc =(String) stringFiled.get(target);
        System.out.println("stringFiled改变之后的值是:"+cc);  
